...
object Helper {
  fun generateAnalysisData(): AnalysisData {
    return AnalysisData(
        ...
        shopAvatar =
            "https://images.tokopedia.net/img/cache/215-square/GAnVPX/2021/3/30/9ee6fbe9-1452-40f6-9b56-42a5bd14e5d5.png")
  }
  ...
  fun generateHistoryItem(): HistoriesItem {
    return HistoriesItem(
        ...
        url =
            "https=//www.tokopedia.com/nutrimartid/tropicana-slim-cafe-latte-10-sch-kopi-bebas-gula",
        productId = "502182312",
        productName = "Tropicana Slim Cafe Latte (10 sch) - Kopi Bebas Gula",
        countPositive = 57,
        countNegative = 43,
  ...
  fun categorizeQueries(queries: List<HistoriesItem>): Map<String, List<HistoriesItem>> {
    ...
    return mapOf("Today" to today, "Yesterday" to yesterday, "Previously" to previously)
  }
}
